...
(defmacro dept:imlet (bindings &body body &environment env)
  "IMMUTABLE-LET: Like CL:LET, but automatically adds type declarations
corresponding to the BINDINGS"
                   ...
                   (unless
                       ...
                       (let ((form-type (cl-form-types:nth-form-type
                         ...
                         (cond ((eq cl:t form-type)
                                ())
                               (t
                                `((extype ,form-type ,var)
                                  (cl:type ,(upgraded-cl-type form-type env) ,var)))))))))
                 ...
                 :do (multiple-value-bind (var form)
                       ...
                       (unless #+sbcl (and (symbol-package var)
                               ...
                               (let* ((form-type (cl-form-types:nth-form-type
                                      ...
                                      (decl `((extype ,form-type ,var)
                                              (cl:type ,(upgraded-cl-type form-type
                                                                          form-type-env)
                                                       ,var))))
...
(defmacro dept:imlet+ (bindings &body body)
